...
import MessageUs from "../../Component/Navbar/MessageUs/MessageUs";
  ...
  const design = (
    <>
      <Head>
        ...
        <title>Contact Us - Forexblues</title>
        <meta name="title" content="Contact Us - Forexblues" />
        <meta
          name="description"
          content="Get in touch with us. Forexblues Customer Support."
        />
        <style>
          {`   
