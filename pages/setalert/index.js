...
import SetAlertHead from "../../Component/SetAlert/SetAlertHead/SetAlertHead";
import SetAlertMain from "../../Component/SetAlert/SetAlertMain/setAlertMain";

import MobSetAlertHead from "../../Component/MobComp/MobSetAlert/MobSetAlertHead/MobSetAlertHead";
import MobSetAlertMain from "../../Component/MobComp/MobSetAlert/MobSetAlertMain/MobSetAlertMain";
...
import TabSetAlertHead from "../../Component/TabComp/TabSetAlert/TabSetAlertHead/TabSetAlertHead";
import TabSetAlertMain from "../../Component/TabComp/TabSetAlert/TabSetAlertMain/TabSetAlertMain";

import Cookies from "universal-cookie";
const AlertNotification = () => {
  const cookies = new Cookies();
  const router = useRouter();
  const fx_1994 = cookies.get("fx_1994");
  useEffect(() => {
    if (fx_1994 == undefined) {
      router.push("/");
    }
  }, []);
  const design = (
