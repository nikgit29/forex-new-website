...
const ForexCalc = () => {
  ...
  const IncDscBuy = async (money) => {
    try {
      ...
      console.log(response.data[0].buy[0], "buy");
  ...
  // Start data according currency API
    ...
    <>
      ...
      >
        <Modal.Header className="d-flex justify-content-center p-0">
          <Modal.Title className={Styles.header}>CURRENT TREND</Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <Container>
            <Row>
              <Col style={{ paddingLeft: "10%", marginRight: "10%" }}>
            ...
            {/* End Enter Amount  */}
            <Row>
              <Col className="text-center mt-3"></Col>
            </Row>
            {/* Start Buttons */}
            <Row
              className="mt-3"
            ...
            >
              ...
              <Col style={{ paddingLeft: "10px", color: "#ccc" }}>
                <span style={{ display: `${view}` }}>
                  Enter Amount and select <br />
                  sell or buy to see
                </span>
