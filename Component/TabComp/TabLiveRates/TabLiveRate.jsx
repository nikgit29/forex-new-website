...
import Style from "./tabliverates.module.css";
...
const MobLiveRates = ({ ExchangeData, height, width }) => {
  ...
  const RateTable = ({ data, index }) => {
    ...
    const ChangeLiveRate = ChangeLiveRateValue[index].toFixed(4);
    ...
    <>
      <Card
        ...
        style={{
          ...
          height: height != undefined ? "500px" : null,
          borderRadius: "23px",
      ...
      >
        <span
          ...
          style={{ color: "#464646", fontWight: "600", fontSize: "14px" }}
        >
          LIVE RATES
        </span>
        ...
        <Card.Body>
          ...
          <div
            ...
            style={{
              overflowY: "scroll",
              height: height != undefined ? null : "160px",
              fontFamily: "roboto",
              textAlign: "center",
            }}
          >
