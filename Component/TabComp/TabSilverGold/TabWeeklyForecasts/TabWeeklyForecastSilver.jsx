...
const MobWeeklyForcastSilver = () => {
  ...
  const trend = silver && silver.trend;
          ...
          <Row className="mt-3" style={{ textAlign: "center" }}>
            <Col>
              ...
              <div className="mt-2" style={{ color: "blue" }}>
                ...
                <span>{silver && silver.dailyrange}</span>
              </div>
            ...
            <Modal show={show} onHide={() => setShow(false)}>
              ...
              <Modal.Body>
                <div className="text-center mb-2" style={{ color: "#004080" }}>
                  <FaRupeeSign /> <b>{silver && silver.dailyrange}</b>
                </div>
                ...
                <Card style={{ width: "100%" }}>
                  <ListGroup variant="flush">
                    ...
                    <ListGroup.Item>
                      <img src={silver && silver.technicalchart} width="100%" />
                    </ListGroup.Item>
                  </ListGroup>
                </Card>
...
export default MobWeeklyForcastSilver;
