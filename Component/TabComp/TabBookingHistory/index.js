...
import Style from "./tabbookinghistory.module.css";
...
const TabBookingHistory = () => {
  ...
  useEffect(() => {
    {
      personId != undefined ? bookingHistory("2022") : null;
    }
  }, [personId]);
              ...
              <div className={Style.main}>
                <div className="text-center">
                  ...
                  <div className={Style.totalAmount}>
                    <span>Total Amount Saved in 2022 : </span>
                    <span>
                  ...
                  <div className={Style.selectYear}>
                    ...
                    <form onChange={(e) => bookingHistory(e.target.value)}>
                      <Form.Select
...
export default TabBookingHistory;
