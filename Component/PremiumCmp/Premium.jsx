...
import TitaniumCallback from "./TitaniumCalllback/TitaniumCallback";
          ...
          <Col>
            <Card className={Styles.card}>
              ...
              <Card.Body>
                ...
                >
                  <div style={{ color: "#2364b5" }}>Weekly Projections</div>
                  <div style={{ color: "#1bd058" }}>
                    <BsCheck2 />
                  </div>
                </div>
                ...
                >
                  <div style={{ color: "#2364b5" }}>Monthly Projections</div>
                  <div style={{ color: "#ff0000" }}>
                    <RiCloseLine />
                  </div>
                </div>
          ...
          <Col>
            <Card className={Styles.card}>
              ...
              <Card.Body>
                ...
                >
                  <div style={{ color: "#2364b5" }}>Forex Risk Assessment</div>
                  <div style={{ color: "#1bd058" }}>
                    <BsCheck2 />
                  </div>
                </div>
                ...
                >
                  <div style={{ color: "#2364b5" }}>Portfolio Management</div>
                  <div style={{ color: "#1bd058" }}>
                    <BsCheck2 />
                  </div>
                </div>
                ...
                >
                  <div style={{ color: "#2364b5" }}>Dedicated Expert</div>
                  <div style={{ color: "#1bd058" }}>
                    <BsCheck2 />
                  </div>
                </div>
