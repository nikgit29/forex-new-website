      ...
      <Container>
        <Row>
          <Col>
            <h1
              className="mt-5 mb-4 "
              style={{ color: color != undefined ? "#919191" : "#ffffff" }}
            >
              FAQ
            </h1>
            <Accordion>
              <Accordion.Item eventKey="0">
                <Accordion.Header>
                  <FaAngleRight /> Who are we and what makes us different?
                </Accordion.Header>
        ...
        <Row className="mt-2">
          <Col>
            <Accordion>
              <Accordion.Item eventKey="0">
                <Accordion.Header>
                  <FaAngleRight /> Where can we make a difference and how?
                </Accordion.Header>
                <Accordion.Body style={{ fontWeight: "500" }}>
                  <p>
        ...
        <Row className="mt-2">
          <Col>
            <Accordion>
              <Accordion.Item eventKey="0">
                <Accordion.Header>
                  <FaAngleRight /> What is our Unique Selling Proposition (USP)?
                </Accordion.Header>
                <Accordion.Body style={{ fontWeight: "500" }}>
                  <p>
        ...
        <Row className="mt-2">
          <Col>
            <Accordion>
              <Accordion.Item eventKey="0">
                <Accordion.Header>
                  <FaAngleRight /> How can I avail ForexBlues Services?
                </Accordion.Header>
                <Accordion.Body style={{ fontWeight: "500" }}>
                  <p>
        ...
        <Row className="mt-2">
          <Col>
            <Accordion>
              <Accordion.Item eventKey="0">
                <Accordion.Header>
                  <FaAngleRight /> What is online forex Advisory Services of
                  ForexBlues?
                </Accordion.Header>
                <Accordion.Body style={{ fontWeight: "500" }}>
                  <p>
        ...
        <Row className="mt-2">
          <Col>
            <Accordion>
              <Accordion.Item eventKey="0">
                <Accordion.Header>
                  <FaAngleRight /> Does forexblues have any percentage or profit
                  sharing in the rate & quotes of other product & services?
                </Accordion.Header>
                <Accordion.Body style={{ fontWeight: "500" }}>
                  <p>
        ...
        <Row className="mt-2">
          <Col>
            <Accordion>
              <Accordion.Item eventKey="0">
                <Accordion.Header>
                  <FaAngleRight /> Explain SELL/BUY options given in the Forex
                  Calculator?
                </Accordion.Header>
                <Accordion.Body style={{ fontWeight: "500" }}>
                  <p>
