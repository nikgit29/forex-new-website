...
import Style from "./weeklyforcasteLogin.module.css";
      ...
      <Card className={Style.card}>
        <Card.Body>
          ...
          <Row className="mt-3" style={{ textAlign: "center" }}>
            <Col
              md={12}
              className={Style.weeklyforecastdropdown}
              ...
              <Modal.Body>
                ...
                <div className="text-center mb-2 ">
                  ...
                  WeeklyDataDetails.trend == "DOWNTREND" ? (
                    <Button
                      className={Style.btnDowntrend}
                      style={{ width: "50%" }}
                    >
                      {WeeklyDataDetails && WeeklyDataDetails.trend}
                    </Button>
                  ) : (
                    <Button className={Style.btn} style={{ width: "50%" }}>
                      {WeeklyDataDetails && WeeklyDataDetails.trend}
                    </Button>
                  )}
                </div>
...
export default WeeklyForcastLogin;
